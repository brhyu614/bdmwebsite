    ...
    <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <JsonLd
        ...
        data={{
          items: [
            {
              q: 'LLM 멀티에이전트 시스템의 실패율은 얼마입니까?',
              a: '공개된 멀티에이전트 시스템 7종을 분석한 MAST 연구(NeurIPS 2025)는 실패율이 41%에서 86.7%에 이른다고 보고했습니다. 실패 기록 1,642건을 분석한 결과 원인의 44.2%는 시스템 설계, 32.3%는 에이전트 간 엇갈림, 23.5%는 검증 부실이었습니다.',
            },
            {
              q: 'AI 에이전트의 실패를 줄이려면 무엇을 해야 합니까?',
              a: '모델을 키우는 대신 설계와 검증에 사람의 판단을 넣어야 합니다. MAST 연구에서 같은 모형을 쓰고 역할 명세만 고쳤을 때 성공률이 9.4%p 올랐고, 상위 검증 단계를 추가했을 때 15.6%p 올랐습니다.',
            },
            {
