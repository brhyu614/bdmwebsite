    ...
    <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <JsonLd
        ...
        data={{
          items: [
            {
              q: '소비자 디지털 트윈이란 무엇입니까?',
              a: '한 사람의 구매 기록과 설문과 인터뷰를 한데 묶어 그 사람의 판단 방식을 되살린 모형입니다. 공장 설비의 디지털 트윈이 기계를 복제해 고장을 미리 돌려 보듯, 소비자 디지털 트윈은 사람의 선택을 복제해 가격 인상과 신제품 출시를 미리 돌려 봅니다.',
            },
            {
              q: '구매 기록으로 소비자의 성향을 어떻게 읽습니까?',
              a: '할인 품목의 비중으로 가격 민감도를, 같은 브랜드를 연속으로 산 횟수로 브랜드 충성을, 처음 사는 품목이 섞이는 비율로 다양성 추구를, 방문 간격의 규칙성으로 계획성을 잽니다. 지표 40여 개를 한 사람당 한 줄로 만듭니다.',
            },
            {
              q: '구매 기록으로 다음 행동을 예측하는 방법은 무엇입니까?',
              a: 'XGBoost가 조건을 나누는 규칙을 수천 개 쌓아 다음 달 구매 확률을 냅니다. 어떤 조건이 예측을 얼마나 밀어 올렸는지도 숫자로 나오기 때문에 맞힌 이유를 사람이 읽을 수 있습니다.',
            },
          ],
        }}
      />
